...
<body>
				...
				<div class="col-lg">
					<form>
						<div class="register">
							...
							<div class="content">
								<textarea name="content" id="idContent"
									placeholder="Bạn có cảm nhận gì về sản phẩm"
									style="height: 100px; width: 1200px"></textarea>
							</div>
							...
							<div class="submit" style="margin-bottom: 50px">
								<button type="button" class="addCommentBtn"
									style="border: 0; color: white; font-size: 15px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; background-color: rgb(20, 208, 250); width: 80px; height: 30px; border-radius: 5px;">
									Đăng</button>
							</div>
						</div>
					</form>
	...
	<script type="text/javascript">
    	$(document).ready(function() {
	    	...
	    	jQuery.ajax({
	    		url: "${base }/productDetail/addComment/${product.id }",
	    		type: "post",
